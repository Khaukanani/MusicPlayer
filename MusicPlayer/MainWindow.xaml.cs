...
namespace Player2
{
    ...
    public partial class Window1 : Window
    {
        ...
        {
           //if the track is playing from a playlist and there is still a track to play go to next track
        }
        ...
        private void SearchBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (seacrh != "")
            {
                ...
                {
                    if (seacrh == playlistBox.Items.ToString())
                    {
                        searchFound = true;
                        TbtStatus.Text = "item found";
                        break;
                    }
                }
            }
            ...
            {
                TbtStatus.Text = "Seacrh box empty";
            }




            // TbkStatus.Text = playlistBox.SelectedItems.Count.ToString() + "item found";
        }
